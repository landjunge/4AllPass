"""store opaque sealed snapshot manifests

Revision ID: c3d8f0a1b2e4
Revises: b7c2a91e4f10
Create Date: 2026-08-18 04:40:00.000000
...
def upgrade() -> None:
    op.add_column("vault_snapshots", sa.Column("manifest_crypto_version", sa.Integer(), nullable=True))
