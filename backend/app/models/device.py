...
class DeviceKeyEnvelope(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("device_key_version >= 1", name="device_key_version_positive"),
    ...
    device_id: Mapped[str] = mapped_column(String(128), nullable=False)
    #: Device-Key generation inside this envelope; part of the AAD.
    device_key_version: Mapped[int] = mapped_column(Integer, nullable=False)
