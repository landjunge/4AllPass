...
INSERT_ENVELOPE = text(
    "INSERT INTO key_envelopes (id, snapshot_id, type, device_id, crypto_version, nonce, ciphertext, "
    "tag, kdf_algorithm, kdf_version, kdf_memory_kib, kdf_iterations, kdf_parallelism, kdf_hash_len, "
    "kdf_salt) VALUES (:id, :snapshot_id, :type, :device_id, :crypto_version, :nonce, :ciphertext, "
...
async def test_master_envelope_requires_kdf_parameters(db_session: AsyncSession) -> None:
    await expect_violation(db_session, type="master", device_id=None)
