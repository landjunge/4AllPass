...
**Far later (nicht Kern):** Clipboard-Watcher, MCP/IDE/n8n-Agent, Auto-Kategorien aus der Zwischenablage. Nur nach Community-Votum oder als optionale **Plus-Schale** (Default aus, gleiches Protokoll). Die PWA behauptet keinen Hintergrund-Watcher.
