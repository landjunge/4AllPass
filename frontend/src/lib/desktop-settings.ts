...
export const LICENSE_HINT =
  "Quelloffen. Privat frei. Kommerziell nicht, außer mit Erlaubnis. PolyForm Noncommercial 1.0.0. / Source is public. Personal use free. Commercial use is not, unless you have permission. PolyForm Noncommercial 1.0.0.";
