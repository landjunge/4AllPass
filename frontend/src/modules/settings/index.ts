...
export const LAUNCH_AT_LOGIN_BROWSER = "Nur in 4AllPass.app. / Desktop app only.";

export const SLEEP_LOCK_HINT =
  "Der Tresor bleibt offen, bis du Sperren drückst. Ruhemodus, Bildschirmsperre, Tray und Wechsel in den Browser sperren nicht. Das ist kein FileVault. / The vault stays open until you press Lock. Sleep, screen lock, tray, and switching to the browser do not lock. That is not FileVault.";

export const LICENSE_HINT =
  "Quelloffen. Privat frei. Kommerziell nur mit Erlaubnis von Daniel Filipek. PolyForm Noncommercial 1.0.0. / Source is public. Personal use free. Commercial use only with permission from Daniel Filipek. PolyForm Noncommercial 1.0.0.";
